...
__decorate([
    n$1({ type: String, attribute: 'scenario-name' })
], RendererConfiguration.prototype, "scenarioName", void 0);
__decorate([
    n$1({ type: String, attribute: 'config-url' })
], RendererConfiguration.prototype, "configUrl", void 0);
__decorate([
    n$1({ type: Boolean, attribute: 'hide-ui' })
